...
#include "SFMTdir/SFMT-params.h"
#include "SFMTdir/SFMT-common.h"
 ...
 */
  static const w128_t sse2_param_mask = {{SFMT_MSK1, SFMT_MSK2,
                                          SFMT_MSK3, SFMT_MSK4}};
  #if defined(_MSC_VER)
    #include "SFMTdir/SFMT-sse2-msc.h"
  #else
    #include "SFMTdir/SFMT-sse2.h"
  #endif
#elif defined(HAVE_NEON)
  #include "SFMTdir/SFMT-neon.h"
#endif
