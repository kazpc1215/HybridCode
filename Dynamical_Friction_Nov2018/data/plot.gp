...
plot NOFRAG u 1:($8/$14):($9/$14) w yerrorlines lw 2 lt 1 ps 0.5 t "Planet1, no frag.",\
NOFRAG u 1:($10/$16):($11/$16) w yerrorlines lw 2 lt 2 ps 0.5 t "Planet2, no frag.",\
NOFRAG u 1:($12/$18):($13/$18) w yerrorlines lw 2 lt 3 ps 0.5 t "Planet3, no frag."

pause PAUSE

set yl "normalized migration distance" offset 2,0
plot FRAG_1E19 u 1:($8/$14):($9/$14) w yerrorlines lw 2 lt 1 ps 0.5 t "Planet1, frag., 10^{19}g",\
FRAG_1E19 u 1:($10/$16):($11/$16) w yerrorlines lw 2 lt 2 ps 0.5 t "Planet2, frag., 10^{19}g",\
FRAG_1E19 u 1:($12/$18):($13/$18) w yerrorlines lw 2 lt 3 ps 0.5 t "Planet3, frag., 10^{19}g"

pause PAUSE

set yl "normalized migration distance" offset 2,0
plot FRAG_1E16 u 1:($8/$14):($9/$14) w yerrorlines lw 2 lt 1 ps 0.5 t "Planet1, frag., 10^{16}g",\
FRAG_1E16 u 1:($10/$16):($11/$16) w yerrorlines lw 2 lt 2 ps 0.5 t "Planet2, frag., 10^{16}g",\
FRAG_1E16 u 1:($12/$18):($13/$18) w yerrorlines lw 2 lt 3 ps 0.5 t "Planet3, frag., 10^{16}g"
...
FRAG_1E19 u 1:6:7 w yerrorlines lw 2 lt 3 ps 0.5 t "numerical, m_{max}=10^{16}g",\
